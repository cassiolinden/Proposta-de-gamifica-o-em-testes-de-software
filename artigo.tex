...
\todo[inline]{Cristiano: avalie se realmente é importante itemizar. Pode escrever em um parágrafo colocando itens (\textit{i}) xxxx; (\textit{ii}) yyy.}
...
\todo[inline]{Cristiano: Essa subseção tem 3 parágrafos, i.e., proporcionalmente maior que as próximas. Poderia no mínimo reduzir 1 parágrafo.}
...
\todo[inline]{Cristiano: sugiro retirar as subsubsections, pode organizar e deixar claro a separação no próprio texto.}
